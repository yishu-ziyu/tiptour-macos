...
Paths in backticks are relative to `tools/voice-acceptance/` unless they start with a top-level directory. Moved from `tools/voice-acceptance/README.md` on 2026-09-23; that file now only points here. Index: [docs/README.md](../README.md).
